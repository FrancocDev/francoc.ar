...
export default async function Home({params: {lang} = {lang : "es"}} : {params?: {lang?: string}}) {
        ...
        {data.projects.slice(0, 3).map((project, i) => (
          <li key={i}>
            ...
            <Link href={project.url}>
              ...
              <Image src={project.image} alt={project.name} fill layout="" className="rounded-lg transition duration-500 hover:scale-105 cursor-pointer"  />
              </div>
            </Link>
